...
class PinController extends Controller
{
    ...
    public function create()
    {
        if($this->pin->countValid() > 500){
            return redirect()->route('pins.index')->with('flash_danger', __('pin_max'));
        }
    ...
    public function verify(PinVerify $req, $student_id)
    {
        ...
        return redirect()->route('pins.enter', Qs::hash($student_id))->with('flash_danger', __('pin_fail'));
    }
    ...
    public function store(PinCreate $req)
    {
        ...
        return redirect()->route('pins.index')->with('flash_success', __('pin_create'));
    }
