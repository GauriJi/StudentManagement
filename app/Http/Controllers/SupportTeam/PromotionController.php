...
class PromotionController extends Controller
{
    ...
    public function promotion($fc = NULL, $fs = NULL, $tc = NULL, $ts = NULL)
    {
        ...
        if($fc && $fs && $tc && $ts){
            ...
            if($sts->count() < 1){
                return redirect()->route('students.promotion')->with('flash_success', __('nstp'));
            }
        }
    ...
    public function promote(Request $req, $fc, $fs, $tc, $ts)
    {
        ...
        if($students->count() < 1){
            return redirect()->route('students.promotion')->with('flash_danger', __('srnf'));
        }
...
//            Insert New Promotion Data
        ...
        return redirect()->route('students.promotion')->with('flash_success', __('update_ok'));
    }
    ...
    public function reset($promotion_id)
    {
        ...
        return redirect()->route('students.promotion_manage')->with('flash_success', __('update_ok'));
    }
