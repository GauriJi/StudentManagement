...
class TimeTableController extends Controller
{
    ...
    public function update(TTRequest $req, $tt_id)
    {
        ...
        return back()->with('flash_success', __('update_ok'));
    ...
    public function delete($tt_id)
    {
        ...
        return back()->with('flash_success', __('delete_ok'));
    }
    ...
    public function store_time_slot(TSRequest $req)
    {
        ...
        if($tf == $tt){
            return response()->json(['msg' => __('invalid_time_slot'), 'ok' => FALSE]);
        }
    ...
    public function use_time_slot(Request $req, $ttr_id)
    {
        ...
        return redirect()->route('ttr.manage', $ttr_id)->with('flash_success', __('update_ok'));
    ...
    public function update_time_slot(TSRequest $req, $ts_id)
    {
        ...
        if($tf == $tt){
            return back()->with('flash_danger', __('invalid_time_slot'));
        }

        $this->tt->updateTimeSlot($ts_id, $data);
        return redirect()->route('ttr.manage', $req->ttr_id)->with('flash_success', __('update_ok'));
    }
