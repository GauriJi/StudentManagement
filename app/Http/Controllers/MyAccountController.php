...
class MyAccountController extends Controller
{
    ...
    public function update_profile(UserUpdate $req)
    {
        ...
        $d = $user->username ? $req->only(['name', 'email', 'phone', 'phone2', 'address']) : $req->only(['name', 'email', 'phone', 'phone2', 'address', 'username']);
    ...
    public function change_pass(UserChangePass $req)
    {
        ...
        return back()->with('flash_danger', __('p_reset_fail'));
    }
