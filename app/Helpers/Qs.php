...
class Qs
{
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        $data = ['name', 'email', 'phone', 'phone2', 'alternate_number', 'dob', 'gender', 'address', 'bg_id', 'nal_id', 'state_id', 'lga_id', 'city'];
    ...
    {
        $data = ['my_class_id', 'section_id', 'my_parent_id', 'dorm_id', 'dorm_room_no', 'year_admitted', 'house', 'age', 'aadhar_card', 'prev_marksheet', 'birth_certificate', 'father_name', 'mother_name', 'father_occupation', 'yearly_income'];
