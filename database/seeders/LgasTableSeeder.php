...
class LgasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $districtsByState = [
            ...
            'Andaman and Nicobar Islands' => ['Andaman Islands', 'Nicobar Islands'],
        ...
        foreach($districtsByState as $stateName => $districts) {
            $stateObj = DB::table('states')->where('name', $stateName)->first();
            if ($stateObj) {
                foreach($districts as $district) {
                    Lga::create(['state_id' => $stateObj->id, 'name' => $district]);
                }
            }
        }
    }
