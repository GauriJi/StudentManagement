            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="ajax-update" method="post" action="{{ route('subjects.update', $s->id) }}">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Subject Code <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input name="subject_code" value="{{ $s->subject_code }}" required type="text" class="form-control" placeholder="Subject Code">
                            </div>
                        </div>
