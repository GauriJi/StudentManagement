                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('subjects.store') }}">
                                ...
                                <div class="form-group row">
                                    <label for="subject_code" class="col-lg-3 col-form-label font-weight-semibold">Subject Code <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input id="subject_code" name="subject_code" value="{{ old('subject_code') }}" required type="text" class="form-control" placeholder="Subject Code">
                                    </div>
                                </div>
