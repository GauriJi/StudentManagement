               ...
               @csrf
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input required type="email" value="{{ old('email') }}" name="email" class="form-control" placeholder="Email Address">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input value="{{ old('city') }}" required type="text" name="city" id="city" placeholder="City" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="father_name" placeholder="Father's Full Name" class="form-control" value="{{ old('father_name') }}" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Mother's Name: <span class="text-danger">*</span></label>
                                <input type="text" name="mother_name" placeholder="Mother's Full Name" class="form-control" value="{{ old('mother_name') }}" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Father's Occupation: <span class="text-danger">*</span></label>
                                <input type="text" name="father_occupation" placeholder="e.g. Farmer, Business" class="form-control" value="{{ old('father_occupation') }}" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Yearly Income (₹): <span class="text-danger">*</span></label>
                                <input type="number" name="yearly_income" placeholder="Annual Income in ₹" class="form-control" min="0" step="0.01" value="{{ old('yearly_income') }}" required>
                            </div>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="d-block">Aadhaar Card: <span class="text-danger">*</span></label>
                                <input type="file" required name="aadhar_card" accept=".jpg,.jpeg,.png,.pdf" class="form-input-styled" data-fouc>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="d-block">Previous Year Marksheet: <span class="text-danger">*</span></label>
                                <input type="file" required name="prev_marksheet" accept=".jpg,.jpeg,.png,.pdf" class="form-input-styled" data-fouc>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="d-block">Birth Certificate: <span class="text-danger">*</span></label>
                                <input type="file" required name="birth_certificate" accept=".jpg,.jpeg,.png,.pdf" class="form-input-styled" data-fouc>
                                <span class="form-text text-muted">Accepted: jpeg, png, pdf. Max 2MB</span>
                            </div>
                        </div>
                    </div>
