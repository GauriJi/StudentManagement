                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input required value="{{ $user->email }}" type="email" name="email" class="form-control" placeholder="your@email.com">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input value="{{ $user->city ?? '' }}" required type="text" name="city" id="city" placeholder="City" class="form-control">
                        </div>
