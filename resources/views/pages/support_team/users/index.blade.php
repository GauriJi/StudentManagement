                    ...
                    <h6>{{ __('msg.personal_data') }}</h6>
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>{{ __('msg.email') }}: <span class="text-danger">*</span></label>
                                        <input required value="{{ old('email') }}" type="email" name="email" class="form-control" placeholder="your@email.com">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                {{--LGA--}}
                                <div class="col-md-4">
                                    <label for="lga_id">{{ __('msg.district') }}: <span class="text-danger">*</span></label>
                                ...
                                {{--City--}}
                                <div class="col-md-4">
                                    <label for="city">{{ __('msg.city') }}: <span class="text-danger">*</span></label>
